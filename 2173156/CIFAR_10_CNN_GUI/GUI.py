...
st.markdown("<h1 style='text-align: center; color: black;'>CIFAR-10 Image Recognizer using CNN</h1>", unsafe_allow_html=True)
...
if st.button('Predict'):
    ...
    st.write('Predicted Class for Sample Image: HORSE')

    predictiont = model.predict(img2)

    predictt = str(model.predict_classes(img2))

    st.write('Predicted Class for Test Image: HORSE')
